...
const FIXED_MISSIONS = [
  ...
  { id: 6, difficulty: 3, mission: "서로의 최애 학교 앞 밥집 1개씩 추천해주기" },
  { id: 7, difficulty: 1, mission: "나와 출신 지역(또는 거주 동네)이 비슷한 사람" },
  { id: 8, difficulty: 2, mission: "나와 같은 기술 스택에 가장 관심 있는 사람" },
  { id: 9, difficulty: 3, mission: "다른 팀 부원과 다음 주 내로 밥약/커피챗 약속 잡기" },
  { id: 10, difficulty: 1, mission: "나와 MBTI 맨 앞자리(E/I)가 반대인 사람" },
  { id: 11, difficulty: 2, mission: "나와 다른 파트인 사람 (프론트/백)" },
  { id: 12, difficulty: 3, mission: "운영진 중 한 명과 같이 셀카 찍기" },
  { id: 13, difficulty: 1, mission: "오늘 나와 비슷한 색깔의 상의를 입은 사람" },
  { id: 14, difficulty: 2, mission: "나와 다른 OS를 사용하는 사람 (맥북/윈도우)" },
  { id: 15, difficulty: 3, mission: "서로의 최애 학교 앞 밥집 1개씩 추천해주기" },
  { id: 16, difficulty: 1, mission: "나와 출신 지역(또는 거주 동네)이 비슷한 사람" },
  { id: 17, difficulty: 2, mission: "나와 같은 기술 스택에 가장 관심 있는 사람" },
  { id: 18, difficulty: 3, mission: "다른 팀 부원과 다음 주 내로 밥약/커피챗 약속 잡기" },
  { id: 19, difficulty: 1, mission: "나와 MBTI 맨 앞자리(E/I)가 반대인 사람" },
  { id: 20, difficulty: 2, mission: "나와 다른 파트인 사람 (프론트/백)" },
  { id: 21, difficulty: 3, mission: "운영진 중 한 명과 같이 셀카 찍기" },
  { id: 22, difficulty: 1, mission: "오늘 나와 비슷한 색깔의 상의를 입은 사람" },
  { id: 23, difficulty: 2, mission: "나와 다른 OS를 사용하는 사람 (맥북/윈도우)" },
  { id: 24, difficulty: 3, mission: "서로의 최애 학교 앞 밥집 1개씩 추천해주기" },
  { id: 25, difficulty: 1, mission: "나와 출신 지역(또는 거주 동네)이 비슷한 사람" },
];
